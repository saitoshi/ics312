...
//ICS 312
//Homework 9
// worked with Robert L and Chris Jensen on this assignment
...
program       :
              ...
              statement*
              {System.out.println("asm_main_cleanup:");
...
printstmt      :
                PRINT print_terms SEMICOLON
                {System.out.println("\tcall print_nl");}
               ;

// parse rule for multiple prints
print_terms     :
                print_term | print_term COMMA print_terms
                ;
//parse rule to print terms
print_term      :
                term
...
subprogstmt     :
                ...
                ;
//parse fule for the function subprogram
funstmt         :
                {int a;}
...
// Semicolon and parentheses and the curly braket
COMMA: ',';
SEMICOLON: ';';
LPAREN: '(';
RPAREN: ')';
